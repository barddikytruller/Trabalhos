...
public class TesteFuncionario {
	...
	public static void main(String[] args) throws DependenteException, FuncionarioException  {
		Dependente dependente01 = new Dependente("Artur", "00345693475", LocalDate.of(2005, 7, 13), Parentesco.FILHO);
		...
		Funcionario funcionario = new Funcionario("Victor Santana", "78965734568", LocalDate.of(1985, 8, 2), 1320.00, dependentes);
